...
/*        db<Lists>(TRC) << "List::remove(e=" << e
    ...
    Element * remove_head() {
/*        db<Lists>(TRC) << "List::remove_head()" << std::endl;*/
    ...
    Element * remove_tail() {
/*        db<Lists>(TRC) << "List::remove_tail()" << std::endl;*/
...
/*        db<Lists>(TRC) << "List::insert_first(e=" << e
    ...
    Element * remove_last() {
/*        db<Lists>(TRC) << "List::remove_last()" << std::endl;*/
...
/*        db<Lists>(TRC) << "Ordered_List::insert(e=" << e
    ...
    Element * remove() {
/*        db<Lists>(TRC) << "Ordered_List::remove()" << std::endl;*/
...
/*        db<Lists>(TRC) << "Ordered_List::remove(e=" << e
    ...
    Element * remove(const Object_Type * obj) {
/*        db<Lists>(TRC) << "Ordered_List::remove(o=" << obj << ")" << std::endl;*/
    ...
    Element * remove_rank(const Rank_Type & rank) {
/*        db<Lists>(TRC) << "Ordered_List::remove_rank(r=" << rank << ")" << std::endl;*/
...
/*        db<Lists>(TRC) << "Scheduling_List::remove(e=" << e
    ...
    Element * choose() {
/*        db<Lists>(TRC) << "Scheduling_List::choose()" << std::endl;*/
...
/*        db<Lists>(TRC) << "Scheduling_List::choose_another()" << std::endl;*/
...
public:
    ...
    void insert_merging(Element * e, Element ** m1, Element ** m2) {
/*        db<Lists>(TRC) << "Grouping_List::insert_merging(e=" << e << ")" << std::endl;*/
    ...
    Element * search_decrementing(unsigned int s) {
/*        db<Lists>(TRC) << "Grouping_List::search_decrementing(s=" << s << ")" << std::endl;*/
        print_head();
        print_tail();
